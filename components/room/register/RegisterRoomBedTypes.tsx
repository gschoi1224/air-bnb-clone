...
const Container = styled.li`
    ...
    .register-room-bed-type-bedrooms-counts {
        font-size: 19px;
...
const RegisterRoomBedTypes: React.FC<IProps> = ({ bedroom }) => {
    ...
    const lastBedOptions = useMemo(() => {
        return bedTypes.filter(
            (bedType) => !activedBedOptions.includes(bedType)
        );
        ...
        <Container>
            <div className="register-room-bed-type-top">
                <div className="register-room-bed-type-bedroom-texts">
                    ...
                    <p className="register-room-bed-type-bedrooms-counts">
